...
class DataViewer(QMainWindow):
    ...
    def UI(self):
        ...
        self.import_button.setIcon(QIcon("导入.svg"))  # 你可以换成你自己的图片
        ...
        self.button_view_data.setIcon(QIcon("图表-折线图.svg"))
        ...
        self.button_view_analysis.setIcon(QIcon("分析.svg"))
        ...
        self.button_view_predict.setIcon(QIcon("推理.svg"))
        ...
        self.button_view_settings.setIcon(QIcon("设置.svg"))
    ...
    def show_predict_page(self):
        ...
        if self.main_stack.count() < 3:  # 如果页面不存在，创建它
            ...
            layout = QVBoxLayout(self.predict_page)
            label = QLabel("这是预测功能页面")
            label.setAlignment(Qt.AlignCenter)
            layout.addWidget(label)
